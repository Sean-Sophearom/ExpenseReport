...
namespace ExpenseReport.UserControls
{
    public partial class UC_Income : UserControl
    {
        ...
        private void InsertBtn_Click(object sender, EventArgs e)
        {
            ...
            if (result) MessageBox.Show("Income record inserted successfully");
        ...
        private void DeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                PopulateDataGrid();
                if (success) MessageBox.Show("Income record deleted successfully");
        ...
        private void UpdateBtn_Click(object sender, EventArgs e)
        {
            ...
            if (result) MessageBox.Show("Income record updated successfully");
